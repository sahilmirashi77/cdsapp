...
public class srtfour extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_srtfour);


        timetext = findViewById(R.id.timetext);
        textView = findViewById(R.id.srttextfour);
    ...
    private void watfinished() {
        ...
        if (i < 9) {
            ...
            mediaPlayer = MediaPlayer.create(srtfour.this, sound[0]);
            mediaPlayer.start();
            i++;
            textView.setText(words[i]);
            ...
            Intent intent = new Intent(srtfour.this, Timeup.class);
