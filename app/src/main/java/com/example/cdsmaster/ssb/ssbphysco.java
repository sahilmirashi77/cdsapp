...
public class ssbphysco extends AppCompatActivity {
...
int i=0;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_ssbphysco);
    ...
    private void Tatfinished() {
        ...
        if(i<12) {
            ...
            mediaPlayer=MediaPlayer.create(ssbphysco.this,sound[0]);
            mediaPlayer.start();
            i++;
            imageView.setImageResource(image[i]);
            ...
            Intent intent=new Intent(ssbphysco.this,Timeup.class);
