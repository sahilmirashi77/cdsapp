...
public class Watthree extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_watthree);

        timetext=findViewById(R.id.timetext3);
        textView=findViewById(R.id.watwords3);
    ...
    private void watfinished() {
        ...
        if(i<9) {
            ...
            mediaPlayer=MediaPlayer.create(Watthree.this,sound[0]);
            mediaPlayer.start();
            i++;
            textView.setText(words[i]);
            ...
            Intent intent=new Intent(Watthree.this,Timeup.class);
