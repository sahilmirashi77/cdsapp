...
public class WAtone extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_w_atone);


        timetext=findViewById(R.id.timetext);
        textView=findViewById(R.id.watwords);
    ...
    private void watfinished() {
        ...
        if(i<9) {
            ...
            mediaPlayer=MediaPlayer.create(WAtone.this,sound[0]);
            mediaPlayer.start();
            i++;
            textView.setText(words[i]);
            ...
            Intent intent=new Intent(WAtone.this,Timeup.class);
