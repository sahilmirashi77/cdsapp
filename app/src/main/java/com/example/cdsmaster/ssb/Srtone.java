...
public class Srtone extends AppCompatActivity {
        ...
        public String[] words={"your going to ssb and some one passes away in your family ,you will....",
                ...
                "","right","crime","grace","wonder","love","fact","knowledge"};
        int i=0;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_srtone);



        timetext=findViewById(R.id.timetext);
            textView=findViewById(R.id.srttext);
        ...
        private void watfinished() {
            ...
            if(i<9) {
                ...
                mediaPlayer=MediaPlayer.create(Srtone.this,sound[0]);
                mediaPlayer.start();
                i++;
                textView.setText(words[i]);
                ...
                Intent intent=new Intent(Srtone.this,Timeup.class);
