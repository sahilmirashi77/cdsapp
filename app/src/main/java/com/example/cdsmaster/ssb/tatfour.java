...
public class tatfour extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_tatfour);
    ...
    private void Tatfinished() {
        ...
        if(i<12) {
            ...
            mediaPlayer= MediaPlayer.create(tatfour.this,sound[0]);
            mediaPlayer.start();
            i++;
            imageView.setImageResource(image[i]);
            ...
            Intent intent=new Intent(tatfour.this,Timeup.class);
