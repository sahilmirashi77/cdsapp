...
public class srtfive extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_srtfive);

        timetext=findViewById(R.id.timetext);
        textView=findViewById(R.id.srttextfive);
    ...
    private void watfinished() {
        ...
        if(i<9) {
            ...
            mediaPlayer=MediaPlayer.create(srtfive.this,sound[0]);
            mediaPlayer.start();
            i++;
            textView.setText(words[i]);
            ...
            Intent intent=new Intent(srtfive.this,Timeup.class);
