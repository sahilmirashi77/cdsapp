...
public class srtthree extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_srtthree);



        timetext=findViewById(R.id.timetext);
        textView=findViewById(R.id.srttextthree);
    ...
    private void watfinished() {
        ...
        if(i<9) {
            ...
            mediaPlayer=MediaPlayer.create(srtthree.this,sound[0]);
            mediaPlayer.start();
            i++;
            textView.setText(words[i]);
            ...
            Intent intent=new Intent(srtthree.this,Timeup.class);
