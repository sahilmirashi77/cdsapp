...
public class tatfive extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_tatfive);
    ...
    private void Tatfinished() {
        ...
        if(i<12) {
            ...
            mediaPlayer=MediaPlayer.create(tatfive.this,sound[0]);
            mediaPlayer.start();
            i++;
            imageView.setImageResource(image[i]);
            ...
            Intent intent=new Intent(tatfive.this,Timeup.class);
